...
class FilesViewModel @Inject constructor(
    ...
    fun pauseDownload(download: DownloadEntity) {
        ...
        val intent = android.content.Intent(application, com.cognitivechaos.xdownload.service.DownloadService::class.java).apply {
            action = com.cognitivechaos.xdownload.service.DownloadService.ACTION_PAUSE
            putExtra(com.cognitivechaos.xdownload.service.DownloadService.EXTRA_DOWNLOAD_ID, download.id)
        }
    ...
    fun resumeDownload(download: DownloadEntity) {
        val application = getApplication<Application>()
        val intent = android.content.Intent(application, com.cognitivechaos.xdownload.service.DownloadService::class.java).apply {
            action = com.cognitivechaos.xdownload.service.DownloadService.ACTION_RESUME
            putExtra(com.cognitivechaos.xdownload.service.DownloadService.EXTRA_DOWNLOAD_ID, download.id)
        }
