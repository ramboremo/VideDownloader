  ...
  public BookmarkDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfBookmarkEntity = new EntityInsertionAdapter<BookmarkEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `bookmarks` (`id`,`url`,`title`,`favicon`,`createdAt`) VALUES (nullif(?, 0),?,?,?,?)";
      }
      ...
      public List<BookmarkEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new BookmarkEntity(_tmpId,_tmpUrl,_tmpTitle,_tmpFavicon,_tmpCreatedAt);
            _result.add(_item);
          }
          return _result;
        } finally {
